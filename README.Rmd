...
The package relies, for the moment, on both the new
[Eurostat's API SDMX 2.1](https://wikis.ec.europa.eu/display/EUROSTATHELP/Transition+-+from+Eurostat+Bulk+Download+to+API)
and on the old [Eurostat's Bulk Download Facility](https://ec.europa.eu/eurostat/data/bulkdownload/).
